...
/**
 * Issue #97: gates the whole app behind a logged-in session. A successful signup clears any
 ...
 * session's local IDs into a fresh signup would silently show a brand-new account another
 * session's family data or a broken questionnaire/results state. Then it stores the
 * access_token and resets the navigation stack back to Splash, which re-runs its own
 * routing — this screen stays unaware of what comes after it.
 */
